    ...
    return (
        <div id='plans' className='d-flex flex-column justify-content-center align-items-center gap-4 text-center'>
            ...
            <div className='d-flex flex-column justify-content-center align-items-center gap-3'>
                <div className='row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 m-2 gap-2 justify-content-center'>
                    {
                        plans.slice(0, slicePlans).map((items: any, index: number) => {
                            return(
                                ...
                                key={index} style={{height: "300px", cursor: "pointer"}} 
                                onClick={() => document?.getElementById("contact")?.scrollIntoView({behavior: "smooth"})}
                                className='d-flex flex-column justify-content-around align-items-center px-2 py-4 bg-black bg-opacity-75 rounded overflow-hidden'>
